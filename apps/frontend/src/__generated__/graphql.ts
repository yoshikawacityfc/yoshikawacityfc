...
export type QueryNewsCollectionQuery = { __typename?: 'Query', newsCollection?: { __typename?: 'newsConnection', edges: Array<{ __typename?: 'newsEdge', cursor: string, node: { __typename?: 'news', title: string, id: any, slug: string, published_at?: any | null, assets?: { __typename?: 'assets', src: string, file_name: string, width: number, height: number } | null } }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, startCursor?: string | null } } | null };
...
export type QueryPreviewNewsCollectionQuery = { __typename?: 'Query', newsCollection?: { __typename?: 'newsConnection', edges: Array<{ __typename?: 'newsEdge', node: { __typename?: 'news', id: any, slug: string, title: string, published_at?: any | null, assets?: { __typename?: 'assets', src: string, file_name: string, width: number, height: number } | null } }> } | null };
...
export type QueryNewsSlugCollectionQueryVariables = Exact<{
  publishedAtFilter?: InputMaybe<DatetimeFilter>;
}>;


export type QueryNewsSlugCollectionQuery = { __typename?: 'Query', newsCollection?: { __typename?: 'newsConnection', edges: Array<{ __typename?: 'newsEdge', node: { __typename?: 'news', slug: string } }> } | null };
...
export type QueryStaffCollectionQuery = { __typename?: 'Query', staffsCollection?: { __typename?: 'staffsConnection', edges: Array<{ __typename?: 'staffsEdge', node: { __typename?: 'staffs', id: any, position: string, name: string, one_word: string, description: string, license: Array<string | null>, career: Array<string | null>, coaching_achievement: Array<string | null>, player_history: Array<string | null>, player_achievement: Array<string | null>, assets?: { __typename?: 'assets', src: string, file_name: string, width: number, height: number } | null } }> } | null };
...
export type QueryAdvisorCollectionQuery = { __typename?: 'Query', staffsCollection?: { __typename?: 'staffsConnection', edges: Array<{ __typename?: 'staffsEdge', node: { __typename?: 'staffs', position: string, name: string, id: any, description: string, assets?: { __typename?: 'assets', src: string, file_name: string, width: number, height: number } | null } }> } | null };
...
export const QueryNewsSlugCollectionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"QueryNewsSlugCollection"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"publishedAtFilter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"DatetimeFilter"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"newsCollection"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"published_at"},"value":{"kind":"EnumValue","value":"DescNullsLast"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"deleted_at"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"is"},"value":{"kind":"EnumValue","value":"NULL"}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"published_at"},"value":{"kind":"Variable","name":{"kind":"Name","value":"publishedAtFilter"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"edges"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}}]}}]}}]} as unknown as DocumentNode<QueryNewsSlugCollectionQuery, QueryNewsSlugCollectionQueryVariables>;
