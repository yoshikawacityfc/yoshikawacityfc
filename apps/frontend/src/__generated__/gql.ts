 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query QueryNewsCollection($first: Int, $after: Cursor, $orderBy: [newsOrderBy!]) {\n    newsCollection(first: $first, after: $after, orderBy: $orderBy) {\n      edges {\n        node {\n          title\n          id\n          slug\n          published_at\n          assets {\n            src\n            file_name\n          }\n        }\n        cursor\n      }\n      pageInfo {\n        endCursor\n        hasNextPage\n        startCursor\n      }\n    }\n  }"): (typeof documents)["query QueryNewsCollection($first: Int, $after: Cursor, $orderBy: [newsOrderBy!]) {\n    newsCollection(first: $first, after: $after, orderBy: $orderBy) {\n      edges {\n        node {\n          title\n          id\n          slug\n          published_at\n          assets {\n            src\n            file_name\n          }\n        }\n        cursor\n      }\n      pageInfo {\n        endCursor\n        hasNextPage\n        startCursor\n      }\n    }\n  }"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
